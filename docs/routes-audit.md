...
| `/{locale}/verify-card` | `src/app/[locale]/verify-card/page.tsx` | Implemented; lookup UX still needs Sprint 3 scope decision |
...
- Decide the final MVP behavior for `/{locale}/verify-card` lookup page.
- Add persona-based E2E for positive member/admin workflows.
