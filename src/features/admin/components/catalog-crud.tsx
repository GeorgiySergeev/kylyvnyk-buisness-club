...
export function CatalogCrud({
  ...
  return (
    <div className="space-y-3">
      <form action={create} className="grid gap-2 rounded-ds-radius-md border border-ds-border bg-ds-bg/50 p-3 md:grid-cols-3 lg:grid-cols-[1fr_1fr_120px_1fr_120px_auto]">
      ...
      {rows.map((row) => (
        <form key={row.id} action={(fd) => update(row.id, fd)} className="grid gap-2 rounded-ds-radius-md border border-ds-border bg-ds-surface-2/35 p-3 md:grid-cols-3 lg:grid-cols-[1fr_1fr_120px_1fr_120px_auto_auto]">
