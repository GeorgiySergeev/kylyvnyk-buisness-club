      ...
      <div className="py-16 sm:py-20 md:py-24 kc-container">
        <div className="mx-auto ">
          <div className="mb-12 space-y-4 text-center sm:mb-16 md:mb-20">
            ...
            <div className="flex flex-wrap items-center justify-center gap-ds-space-5 pt-ds-space-2 text-ds-text-sm text-ds-text-muted">
              <a
          ...
          <div className="grid grid-cols-1 border-y border-ds-border md:grid-cols-3">
            ...
            <div className="border-t border-ds-border px-6 py-8 sm:px-8 sm:py-10 md:border-t-0 md:border-l md:px-10">
              <h3 className="mb-4 text-ds-text-sm font-semibold text-ds-text">
          ...
          <div className="mt-10 space-y-6 border-t border-ds-border pt-10 sm:mt-12 sm:pt-12">
